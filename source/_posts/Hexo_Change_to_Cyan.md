...
- Hexo
photos:
- http://floretten-1252347631.costj.myqcloud.com/cyan/cyan.png
---

国内若干第三方评论系统纷纷倒下后，决定尝试使用畅言作为评论系统。

<!--more-->

## 源起

博客创立之初一直使用多说的评论系统，直到四月份收到通知，多说将在2017年6月1日起停止服务。因为懒于打理迁移，博客一度放弃了评论系统。后经过知乎等网友们的对比，先后将目光放在了友言和畅言，然而友言折腾起来真的是不好使，各种加载不出来，随机放弃尝试畅言。

## 畅言配置

关于这种比较完善的第三方系统配置，官方往往都有详细说明，再不济网上也有老司机们写好的教程，此处不再过多赘述。
**值得注意**的是使用畅言必须提供网站的备案号，否则只能使用 15 天。毕竟现在国家网络信息管的紧，网站都需要备案的，使用独立的域名的司机们应该都备过案了。另外的福利是畅言有广告服务，同意其广告协议可以有广告收入，当然如果你不需要可以不用管它。
